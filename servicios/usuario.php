<?php
 class Usuario
 {
     ...
     public function getPwMaquinista()
     {
         return $this->pw_maquinista;
     }

     public function getTxCorreo()
     {
         return $this->tx_correo;
     }

     public function getTxSesion()
     {
         return $this->tx_sesion;
     }

     public function getTxActivo()
     {
         return $this->tx_activo;
     }

     public function setIdMaquinista($valor)
     {
         $this->id_maquinista = (string) $valor;
     }

     public function setPwMaquinista($valor)
     {
         $this->pw_maquinista = (string) $valor;
     }

     public function setTxCorreo($valor)
     {
         $this->tx_correo = (string) $valor;
     }

     public function setTxSesion($valor)
     {
         $this->tx_sesion = (string) $valor;
     }

     public function setTxActivo($valor)
     {
         if ($valor === 'S' || $valor === 's' || $valor === '1' || $valor === 1) {
             $this->tx_activo = 'S';
         } elseif ($valor === 'N' || $valor === 'n' || $valor === '0' || $valor === 0) {
             $this->tx_activo = 'N';
         } else {
             $this->tx_activo = null;
         }
