<?php
	class mdlTren {
	    ...
	    public function set($array) {
	    	...
	    	if (isset($array['id_maquinista'])) 	$this->setIdMaquinista($array['id_maquinista']		);
	    	if (isset($array['fc_construccion']))	$this->setFcConstruccion($array['fc_construccion']	);
	    	if (isset($array['tx_tren'])) 			$this->setTxTren($array['tx_tren']					);
		...
		public function getIdTren()			{ return $this->id_tren;		}
		public function getIdMaquinista()	{ return $this->id_maquinista; 	}
		public function getTxTren()			{ return $this->tx_tren; 		}
		public function getFcConstruccion()	{ return $this->fc_construccion;}
	...
	class Tren extends mdlTren {
		...
		public function guardar() {
			if ($this->getIdTren() == "") {
				...
				if ($this->insert()) new MensajeSistema("Se ha creado el Tren ".$this->getTxTren(), 0);
			} else {
				if ($this->update()) new MensajeSistema("Se ha actualizado el Tren ".$this->getTxTren(), 0);
			}
		}
		public function listar(){
			...
			if (count($result)==0) $result[] = new mdlTren();
			return $return;
		}
	}
?>